...
export const skillsByCategory: Record<SkillCategory, string[]> = {
  frontend: [
    ...
    'Nuxt.js', 'Redux', 'Zustand', 'Tailwind CSS', 'GSAP', 'Framer Motion'
  ],
  backend: [
    'Node.js', 'Express', 'GraphQL', 'REST APIs', 'Prisma'
  ],
  database: [
  ...
  devops: [
    'Docker', 'AWS', 'Vercel', 'Netlify', 'CI/CD', 'GitHub Actions'
  ],
  tools: [
    'Git', 'VS Code', 'Figma', 'Postman', 'Chrome DevTools'
  ],
  design: [
    'Figma', 'UI/UX', 'Responsive Design', 'Design Systems'
  ],
};
...
export const getTechnologiesByCategory = (category: SkillCategory): TechnologyTag[] => {
